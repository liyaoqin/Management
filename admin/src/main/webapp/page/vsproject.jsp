...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#demo'
            ,url: '${ pageContext.request.contextPath }/project/viewsproject?userid='+${activeUser.id} //数据接口
            ,width:3000
            ,page: true //开启分页
            ,cols: [[ //表头
                ...
                ,{field: 'concludingstatus', title: '结题状态', width:150}
        ...
        $(document).on('click','.layui-btn-xs',function () {
            ...
            parent.layer.open({
                ...
                shadeClose: false, //点击遮罩关闭
                area: ['500px', '500px'],
                content: '${ pageContext.request.contextPath }/page/dresult/'+pid
            });
        });
    });
</script>
