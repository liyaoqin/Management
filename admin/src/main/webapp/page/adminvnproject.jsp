...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#demo'
            ,url: '${ pageContext.request.contextPath }/project/adminviewnproject' //数据接口
            ,width:3000
            ,page: true //开启分页
            ,cols: [[ //表头
        ...
        $(document).on('click','#pass',function () {
            ...
            parent.layer.confirm('确定通过此项目申报吗', function(index){
                parent.layer.close(index);
                $.post("${ pageContext.request.contextPath }/project/passproject/"+pid,function(data){
                    if(data.status==200){
        ...
        $(document).on('click','#npass',function () {
            ...
            parent.layer.open({
                ...
                shadeClose: false, //点击遮罩关闭
                area: ['500px', '500px'],
                content: '${ pageContext.request.contextPath }/page/npassproject/'+pid
            });
        });
    });
</script>
