...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#demo'
            ,url: '${ pageContext.request.contextPath }/result/viewfresult?userid='+${activeUser.id}
            ,width:2500
            ,page: true //开启分页
            ,cols: [[ //表头
                ...
                ,{field: 'reason', title: '申请失败原因', width:200}
                ,{field: 'audit', title: '状态', width:150}
        ...
        $(document).on('click','.layui-btn-xs',function () {
            ...
            parent.layer.open({
                ...
                shadeClose: false, //点击遮罩关闭
                area: ['500px', '500px'],
                content: '${ pageContext.request.contextPath }/page/againresult/'+pid
            });
        });
    });
</script>
