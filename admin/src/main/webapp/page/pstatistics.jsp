...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#demo'
            ,url: '${ pageContext.request.contextPath }/dnotice/viewndnotice' //数据接口
            ,width:2000
            ,page: true //开启分页
            ,cols: [[ //表头
                ...
                ,{field: 'declaration', title: '申报书模板', width:300}
                ,{field: 'number', title: '申报结果', width:300}
        ...
        $(document).on('click','.layui-btn-xs',function () {
            ...
            parent.layer.open({
                ...
                shadeClose: false, //点击遮罩关闭
                area: ['500px', '500px'],
                content: '${ pageContext.request.contextPath }/page/detaildnotice/'+pid
            });
        });
    });
</script>
