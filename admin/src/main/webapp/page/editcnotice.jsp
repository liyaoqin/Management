...
<form class="layui-form" action="">
    ...
    <input type="hidden" name="creports" id="myinput" value="${declaration}">
    <label class="layui-form-label">上传结题报告书模板</label>
    <button type="button" class="layui-btn" id="test1">
        <i class="layui-icon">&#xe67c;</i>点击上传
    </button>
    文件名称: <span id="fileName">${creports}</span><br>
...
<script>
    ...
    layui.use(["layer","form","upload","jquery","element"], function(){
        ...
        form.on('submit(formDemo)', function(data){
            $.ajax({
                url: "${ pageContext.request.contextPath }/cnotice/editcnotice",
                type: "POST",
                data:data.field,
