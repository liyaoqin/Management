...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#demo'
            ,url: '${ pageContext.request.contextPath }/project/view' //数据接口
            ,width:2500
            ,page: true //开启分页
            ,cols: [[ //表头
                ...
                ,{field: 'participants', title: '其他项目参与人员', width:300}
                ,{field: 'grade', title: '年级', width:150}
                ,{field: 'budget', title: '经费预算', width:100}
                ,{field: 'concludingstatus', title: '结题状态', width:100}
                ,{field: 'audit', title: '审核状态', width:100}
                ,{field: 'pdeclaration', title: '申报书模板', width:150}
