package com.science.admin.realm;

import com.science.admin.pojo.Adminuser;
import com.science.admin.service.PermissionService;
...
public class DatabaseRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        SimpleAuthenticationInfo a = new SimpleAuthenticationInfo(activeUser,passwordInDB,ByteSource.Util.bytes(salt),getName());
        return a;
    }
